"""JAS aggregation PySpark script for Snapchat."""
...
class SnapchatJASJob(BaseJASJob):
    """JAS aggregation job for Snapchat."""

    def __init__(self):
        super().__init__('JAS Aggregation for Snapchat', 'snapchat')
